...
//content: '<div class="infowindow"> Los Feliz Dr and N Skyline Dr Stop 1: intersection near high concentration of medium-high density housing</div>',
  var infowindow = new google.maps.InfoWindow(
    {
      content: '<table class="table table-hover"><caption>Hover Table Layout</caption><thead><tr><th>Attribute</th><th>Value</th></tr></thead><tbody><tr id="attr1"><td>Tanmay</td><td>Bangalore</td></tr></tbody></table>', 
      map: map,
      position: myLatlng
...
//$.each(success, function(a, b){alert(a+" "+b)});
